namespace My_performance
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.CPU_NAME = new System.Windows.Forms.NotifyIcon(this.components);
			...
			this.CPU.MachineName = "DESKTOP-3QTOH2O";
			// 
			// timer1
			// 
			...
			// CPU_NAME
			// 
			this.CPU_NAME.Text = "notifyIcon1";
		...
		private System.Windows.Forms.NotifyIcon CPU_NAME;
